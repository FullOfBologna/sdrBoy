...
class CPU(SingletonBase):
    ...
    def step(self):
        ...
        if opCode in self.lr35902_opCodes:
            opCodeFunc, length, cycles, flags = self.lr35902_opCodes[opCode]

            #Address of potential immediate operand
            operandAddress = (currentPC + 1) & 0xFFFF

            nextPcOverride, cycleCountOverride = opCodeFunc(operandAddress, flags)
    ...
    def init_opCodes(self):
        self.lr35902_opCodes = {
            ...
            0x34: (self._inc_hl,        1,[ 12],      "Z0H-"),
            0x35: (self._dec_hl,        1,[ 12],      "Z1H-"),
        ...
        # def _nop(self):
        #     return self.lr35902_opCodes[0x00][2]
